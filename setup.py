...
setup(
    ...
    packages=['sql2bag', 'bag2dams', 'dams2bag'],
    package_dir={'sql2bag': 'sql2bag/sql2bag', 'bag2dams': 'bag2dams/bag2dams', 'dams2bag': 'dams2bag/dams2bag'},
    package_data={'sql2bag': ['gpcr_example/*.*']},
    scripts=['bin/iobox_sql2dams.py'],
    requires=['orderdict', 'simplejson', 'pyodbc', 'csv', 'os', 'sys', 'datetime', 'json', 'bagit', 'requests'],
